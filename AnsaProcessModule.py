...
class InformationElement():
	...
	def frombytes(cls, octets):
		...
		if tag in [Tag.result_code, Tag.process_id, Tag.script_return_type, \
				Tag.script_execution_details, Tag.supported_service, Tag.post_connection_action]:
...
class IAPConnection():
	...
	def run_script_file(self, filepath, function_name, pre_execution_database_action = PreExecutionDatabaseAction.reset_database):
	...
	def run_script_text(self, script_text, function_name = None, pre_execution_database_action = PreExecutionDatabaseAction.reset_database):
